...
every request. Without a secret, local development behavior remains unchanged.
Browser clients receive CORS access only from loopback origins; native MCP
clients do not need CORS.
