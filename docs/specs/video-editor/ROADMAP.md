...
| K-B | partial | **K-B1/K-B2 stacks, K-B4 presets, K-B12 easing, K-B14 freeze frame, K-B15 paste attributes and K-B16 catalogue bridge done.** Open: K-B3 effect zones, K-B5 compare view, K-B6 param expressions, K-B11 keyframe interchange; manifest `Applicability` gating still open because all 45 entries declare `CLIP_ONLY` | [30](30-effect-catalogue.md), [26 §10](26-kdenlive-mlt-parity.md#10-k-b--effects-and-compositing) |
