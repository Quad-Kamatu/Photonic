...
| K-B | partial | **K-B1/K-B2 track/master/asset stacks done** (`VfxOwner`, scoped commands, inspector tabs, MCP `effect_stack`) and **K-B16 catalogue bridge done**. Open: effect zones, presets, compare view, param expressions, keyframe interchange, easing, freeze frame, paste attributes; manifest `Applicability` gating still open because all 45 entries declare `CLIP_ONLY` | [30](30-effect-catalogue.md), [26 §10](26-kdenlive-mlt-parity.md#10-k-b--effects-and-compositing) |
