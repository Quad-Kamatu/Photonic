...
| K-A | partial | **Timecode + Split A/V + Edit Duration + Grab nudge + K-A4 snap completeness landed**. Open: preview chunks (K-A1, mini-spec first), marker depth, spacer, subclips, fixed playhead, groups (K-A5, mini-spec first) | [33](33-timeline-preview-render.md) (K-A1), [26 §9](26-kdenlive-mlt-parity.md#9-k-a--timeline) |
| K-B | partial | **K-B1/K-B2 stacks, K-B12 easing presets, K-B15 paste attributes and K-B16 catalogue bridge done.** Open: effect zones, presets, compare view, param expressions, keyframe interchange, freeze frame; manifest `Applicability` gating still open because all 45 entries declare `CLIP_ONLY` | [30](30-effect-catalogue.md), [26 §10](26-kdenlive-mlt-parity.md#10-k-b--effects-and-compositing) |
