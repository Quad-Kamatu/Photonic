...
| K-0.2 | Render the six declared-but-passthrough effects | ✅ `fca5eda`+shared blur — all 6 kernels CPU+GPU (Blur/Sharpen/Glow via separable Gaussian) | all of [K-B](#10-k-b--effects-and-compositing) | P5/P7, [02 §2](02-engine.md) |
